...
def hv_main():
    ...
    history_wordtext = str(list(reversed(history_wordlist)))
    ...
    history_timetext = history_time_func(list(reversed(history_timelist)))
    ...
    master.geometry('600x'+str(len(history_wordlist)*30+30))
    ...
    history_word_header = tk.Label(master, font=("MS Gothic", "15", "bold"), bg="white", justify="left", anchor="e", text="words\n-----------------------------------")
    history_time_header = tk.Label(master, font=('MS Gothic', '15', 'bold'), bg="white", justify="left", anchor="e", text='times\n-----------------------------------')
    history_word_header.place(x=0, y=0)
    history_time_header.place(x=300, y=0)

    history_word_tt = tk.Text(master, font=("MS Gothic", "15", "bold"), relief='flat')
    ...
    history_time_tt = tk.Text(master, font=("MS Gothic", "15", "bold"), relief='flat')
